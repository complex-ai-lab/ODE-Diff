...
def parse_args():
    ...
    parser.add_argument('--w_v', type=float, default=0., help='Guidance strength for cval.')
    parser.add_argument('--w_d', type=float, default=0., help='Guidance strength for cdir.')

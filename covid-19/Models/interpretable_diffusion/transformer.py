...
class DecoderBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.attn_label = CrossAttention(
                n_embd=n_embd,
                condition_embd=condition_dim,
                n_head=n_head,
                attn_pdrop=attn_pdrop,
        ...
        self.ln_label = nn.LayerNorm(n_embd)
        ...
        self.label_proj = nn.Linear(1, n_embd)
...
class Transformer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__()
        self.emb = Conv_MLP(n_feat+1, n_embd, resid_pdrop=resid_pdrop)
    ...
    def forward(self, input, t, a, padding_masks=None, return_res=False):
        ...
        enc_cond = self.encoder(inp_enc, t, padding_masks=padding_masks, label_emb=a)
        inp_dec = self.pos_dec(emb)
        output, mean, trend, season = self.decoder(inp_dec, t, enc_cond, padding_masks=padding_masks, label_emb=a)

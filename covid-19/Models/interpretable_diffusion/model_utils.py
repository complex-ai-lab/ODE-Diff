...
class PredictionModel(nn.Module):
    def __init__(self, input_dim, seq_len, n_head, n_embd, attn_pdrop=0.1, resid_pdrop=0.1):
        super().__init__()
        self.input_dim = input_dim
        self.seq_len = seq_len
        self.feature_proj = nn.Linear(input_dim, n_embd)
...
class AdaLayerNorm(nn.Module):
    def __init__(self, n_embd, label_dim=52):
        super().__init__()
